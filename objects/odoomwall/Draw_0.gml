...
if GLOBAL.roundStart {
	if oRender.disable == 2 {
		...
		draw_sprite_ext(sDoomWall,0,CamXReal-Wrap(CamXReal,0,texWidth),CamYReal-Wrap(CamYReal,0,texHeight),1920/texWidth+1,1080/texHeight+1,0,c_white,disappear/50);
	} else {
		if wallLen == -70 {
			draw_sprite_ext(sDoomWall,0,CamXReal-Wrap(CamXReal,0,texWidth),CamYReal-Wrap(CamYReal,0,texHeight),1920/texWidth+1,1080/texHeight+1,0,c_white,1);	
		} else {
